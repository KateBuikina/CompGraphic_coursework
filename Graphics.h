...
protected:
	...
	struct triangle
	{
		...
		{
			vertex_list[0].x = x1; vertex_list[0].y = y1; vertex_list[0].z = z1;
			vertex_list[1].x = x2; vertex_list[1].y = y2; vertex_list[1].z = z2;
			vertex_list[2].x = x3; vertex_list[2].y = y3; vertex_list[2].z = z3;
		}
